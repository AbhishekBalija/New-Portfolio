<script lang="ts">
	...
	const handleMouseMove = (e: MouseEvent) => {
		...
		const manX = window.innerWidth - 250;

		gsap.to('.hover-revel', {
			x: gsap.utils.clamp(0, manX, mousePos.x - 110),
...
<div
	class="hover-revel pointer-events-none absolute left-0 top-0 -z-10 h-[320px] w-[220px] rounded-lg bg-cover bg-center opacity-0 transition-[background] duration-300"
