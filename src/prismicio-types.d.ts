...
type BlogDocumentDataSlicesSlice = ImageBlockSlice | RichTextSlice;
...
export type AllDocumentTypes = BlogDocument | PageDocument | ProjectDocument | SettingsDocument;
...
export interface HeroSliceDefaultPrimary {
	...
	/**
	 * Tag Field field in *Hero → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: hero.default.primary.tag_field
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	tag_field: prismic.KeyTextField;
}
